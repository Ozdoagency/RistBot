...
5. С сохранением общей структуры диалога, но гибкими в формулировках
...
1. **Приветствие и цель**  
*"Здравствуйте, {name}! 👋 Меня зовут Виктория, я представляю онлайн-школу 'Rist'. Мы рады, что вы выбрали нас! Расскажите, пожалуйста, какую цель вы хотите достичь с помощью занятий? Например, устранить пробелы, повысить оценки или подготовиться к экзаменам. 🎯"*

2. **Сбор информации**  
Цель — получить ответы на вопросы: цель обучения, класс ученика, темы, ��оторые вызывают трудности, и удобное время.
...
- **Удобное время:**  
  ...
  *"Отлично, сейчас уточню доступность. 🌟"*

- **Подтверждение времени:**  
  "Спасибо! Сейчас уточню доступность. Мы свяжемся с вами для подтверждения запи��и. Укажите, пожалуйста, ваш номер телефона для связи. ☎️"  
  *"Спасибо за ваш номер! 📞"*
  ...
  questions: [
    {
      ...
      text: "Здравствуйте! {name} 👋 Меня зовут Виктория, я представляю онлайн-школу 'Rist'. Мы рады, что вы выбрали нас! Расскажите, пожалуйста, какую цель вы хотите достичь с помощью занятий? Например, устранить пробелы, повысить оценки или подготовиться к экзаменам. 🎯",
      isTemplate: true,
      contextRules: [
        "Подстраивайтесь под время суток",
        "Используйте имя клиента из переменной {name}",
    ...
    },
    {
      ...
      contextRules: [
        "Делайте акцент на уровне знаний, если клиент уточняет"
      ]
    },
    {
      stage: "Темы по математике",
      text: "С какими темами по математике у ребёнка сложности? Например, дроби, алгебра, геометрия? 🔢",
      joinText: "Спасибо за уточнение! 👌",
      contextRules: [
        "При необходимости перефразируйте примеры тем"
      ]
    },
    {
      stage: "Удобное время",
      ...
      contextRules: [
        "Уточняйте предпочтения клиента, если он предлагает диапазон времени"
      ]
    },
    {
      stage: "Подтверждение времени",
