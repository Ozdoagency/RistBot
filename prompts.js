...
5. С сохранением общей стр��ктуры диалога, но гибкими в формулировках
...
2. **Сбор информации**  
Цель — получить ответы на вопросы: цель обучения, класс ученика, темы, которые вызывают трудности, и удобное время.
  ...
  questions: [
    {
      ...
      contextRules: [
        ...
        "Отражайте стиль об��ения собеседника"
      ]
    },
    {
      stage: "Класс ученика",
    ...
    },
    {
      ...
      contextRules: [
        "Уточняйте предпочтения ��лиента, если он предлагает диапазон времени"
      ]
    },
    {
