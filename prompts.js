...
*"Расскажите, пожалуйста, какую цель вы хотите достичь с помощью занятий по математике? Например, устранить пробелы, повысить оценки или подготовиться к экзаменам."* 🎯
...
const dialogStages = {
  questions: [
    ...
    {
      stage: "Темы",
      text: "С ��акими темами по математике у ребёнка сложности? Например, дроби, алгебра, геометрия? 🔢",
