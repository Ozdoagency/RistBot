...
bot.on('polling_error', (error) => logger.error(`Ошибка polling: ${error.message}`));
bot.on('webhook_error', (error) => logger.error(`Ошибка webhook: ${error.message}`));
...
bot.onText(/\/start/, async (msg) => {
  ...
  Расскажите, пожалуйста, какие конкретные пробелы вы хотите устранить и в какой области? Например, устранить пробелы в знаниях, повысить оце��ки или что то другое. 🎯`;
