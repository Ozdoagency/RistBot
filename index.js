...
bot.onText(/\/start/, async (msg) => {
  ...
  const welcomeMessage = `Здравствуйте, ${firstName}! 👋 Меня зовут Виктория, я представляю онлайн-школу 'Rist'. Расскажите, пожалуйста, какую цель вы хотите достичь с помощью занятий? Например, подготовка к экзаменам, повышение оценок или устранение пробелов 🎯`;
